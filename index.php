        ...
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                ...
                <p class="mbr-text align-center py-2 mbr-fonts-style display-5"><strong>
                        Philippine Local Emergency App</strong><br>Providing emergency services communication to every Juan and Juana.</p>
        ...
        <div class="media-container-row align-center mbr-white">
            <div class="col-12">
                <p class="mbr-text mb-0 mbr-fonts-style display-7">
                    © Copyright 2019 PLEMA Digital - All Rights Reserved
                </p>
            </div>
        </div>
    </div>
