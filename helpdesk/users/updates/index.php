      ...
      <div class="row">
        ...
        <div class="col col-md-6">
          ...
          if($eCount>0) {?>
              ...
              <p>These can often be ignored...especially if they mention duplicate columns.  Feel free to check with us in Discord or on the PLEMA.digital forums if you have any questions.</p>
