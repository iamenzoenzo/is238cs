...
<div class="content mt-3">
  ...
  <h4 align="center">
    ...
    if(version_compare($remoteVersion, $user_spice_ver) ==  1){
      echo "Updates are available at <a href='https://www.userspice.com/updates'>PLEMA.digital/updates</a><br>";
    } else {
      echo "You are running the latest version!";
    }
  }else{
    echo "We are sorry. PLEMA.digital is not reachable by this server. Please try back later.";
  }
?>
<br><br>
<?php
...
if(isset($result->next_ver) && $result->next_ver != ""){
  ...
  if($result->no_update > 0){
    if($result->no_update == 1){
      die("$result->next_ver must be installed manually from PLEMA.digital/updates");
